...
<!--  <div class="post-detail-page">-->
<!--    <header class="header">-->
<!--&lt;!&ndash;      <h1 class="title">{{ post.title }}</h1>&ndash;&gt;-->
<!--      &lt;!&ndash; Back Icon &ndash;&gt;-->
<!--      <img src="@/assets/arrowLeft.svg" alt="back-icon" @click="goBack" class="back-icon"/>-->

<!--      &lt;!&ndash; 설정 아이콘 및 드롭다운 메뉴 &ndash;&gt;-->
<!--      <div class="settings-menu">-->
<!--        <img src="@/assets/dots-vertical.svg" alt="dots-vertical"  @click="toggleSettingsMenu"/>-->
<!--        <div v-if="showSettingsMenu" class="dropdown-menu">-->
<!--          <ul>-->
...
<!--&lt;!&ndash;    <div class="post-content">&ndash;&gt;-->
<!--&lt;!&ndash;      <p>{{ post.content }}</p>&ndash;&gt;-->
<!--&lt;!&ndash;    </div>&ndash;&gt;-->

<!--&lt;!&ndash;    <div class="post-likes" @click="likePost">&ndash;&gt;-->
<!--&lt;!&ndash;      <span :class="likedByUser ? 'liked' : ''">❤️ {{ post.likes }}</span>&ndash;&gt;-->
<!--&lt;!&ndash;    </div>&ndash;&gt;-->
<!--    <div class="post-content">-->
<!--      <p>{{ post.content }}</p>-->
<!--    </div>-->
...
<!--      <div class="likes-comments">-->
<!--        <img src="@/assets/heart-rounded.svg" alt="like" @click="likePost" class="action-icon" />-->
<!--        &lt;!&ndash; Fix the class binding for likedByUser &ndash;&gt;-->
<!--        <span :class="{ liked: likedByUser }" class="likes-count">공감 {{ post.likes }}</span>-->
<!--        <img src="@/assets/message-square.svg" alt="comments" class="action-icon" />-->
<!--        <span class="comment-count">댓글 {{ post.commentsCount }}</span>-->
<!--      </div>-->
...
<!--    &lt;!&ndash; 댓글 리스트 및 수정/삭제 기능 추가 &ndash;&gt;-->
<!--    <CommentList :comments="comments" :replies="replies"-->
<!--                 @update-comment-reply-count="updateCommentReplyCount"-->
<!--                 @update-comment="handleUpdateComment"-->
<!--                 @delete-comment="handleDeleteComment"-->
...
<!--    &lt;!&ndash; 댓글 입력 &ndash;&gt;-->
<!--&lt;!&ndash;    <div class="comment-input">&ndash;&gt;-->
<!--&lt;!&ndash;      <textarea&ndash;&gt;-->
<!--&lt;!&ndash;          v-model="newComment"&ndash;&gt;-->
<!--&lt;!&ndash;          placeholder="댓글을 입력하세요..."&ndash;&gt;-->
<!--&lt;!&ndash;          rows="3"&ndash;&gt;-->
<!--&lt;!&ndash;      ></textarea>&ndash;&gt;-->
<!--&lt;!&ndash;      <button @click="submitComment" class="submit-btn">댓글 등록</button>&ndash;&gt;-->
<!--&lt;!&ndash;    </div>&ndash;&gt;-->
<!--    <CommentInput-->
...
<!--&lt;!&ndash;    <router-link to="/community" class="back-link">목록</router-link>&ndash;&gt;-->
<!--  </div>-->
<!--</template>-->
...
<!--}-->
<!--.submit-comment{-->
<!--  position: static; /* 혹은 다른 적절한 위치 설정 */-->
<!--  bottom: auto;-->
<!--  left: auto;-->
<!--  width: 100%;-->
