        ...
        <div class="profile-section">
            ...
            <div class="user-info">
                <div class="user-detail">
                    ...
                    <span class="user-a">{{ user.nickname || "닉네임을 등록해주세요" }}</span>
                </div>
                <div class="user-detail">
                    <span class="user-q">생년월일</span>
                    <span class="user-a">{{ user.birthDate || "생년월일을 등록해주세요" }}</span>
                </div>
                <div class="user-detail">
                    <span class="user-q">휴대폰 번호</span>
                    <span class="user-a">{{ user.phoneNumber || "휴대폰 번호를 등록해주세요" }}</span>
                </div>
                <div class="user-detail">
                    <span class="user-q">이메일 주소</span>
                    <span class="user-a">{{ user.email || "이메일 주소를 등록해주세요" }}</span>
                </div>
            </div>
        </div>
